  ...
  return (
    <header className="py-6 lg:py-8">
      <div className="max-md:relative container-1600 flex justify-center md:justify-between items-start md:items-center">
        ...
        <DesktopNavBar />
        <div
          className={`a dark:bg-custom-white dark:text-custom-black bg-custom-black text-custom-white rounded-full w-fit py-0.5 md:py-1 px-2 md:px-4 absolute md:static max-md:top-4 max-md:right-0`}
        >
          Store
        </div>
      </div>
